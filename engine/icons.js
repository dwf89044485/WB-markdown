...
export const ICONS = {
  ok: '<svg width="10" height="8" viewBox="0 0 10 8" fill="none"><path d="M1 4l2.5 3L9 1" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  spin: '<svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="8" stroke="currentColor" stroke-width="2"/><path d="M10 2a8 8 0 018 8" style="stroke:var(--color-accent-purple)" stroke-width="2" stroke-linecap="round"/></svg>',
  ...
  todoOk: '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path class="todo-done-icon" fill="currentColor" transform="matrix(1 0 0 1 2.67627 3.97617)" d="M11.3137 0.9428L4.2426 8.0139L0 3.7712L0.9428 2.8284L4.2426 6.1283L10.3709 0L11.3137 0.9428Z"/></svg>',
  todoSpin: '<svg class="spin" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path style="fill:var(--color-accent-green)" transform="matrix(1 0 0 1 2.07097 1.5)" d="M6.529 0L6.529 4L5.329 4L5.329 0L6.529 0ZM8.394 5.7697L11.8581 3.7697L11.258 2.7305L7.7939 4.7305L8.394 5.7697ZM3.4641 5.7698L0 3.7698L0.6 2.7305L4.0641 4.7305L3.4641 5.7698ZM7.7939 8.2697L11.258 10.2697L11.8581 9.2305L8.394 7.2305L7.7939 8.2697ZM4.0641 8.2697L0.6 10.2697L0 9.2305L3.4641 7.2305L4.0641 8.2697ZM6.529 9L6.529 13L5.329 13L5.329 9L6.529 9Z" fill-rule="evenodd"/></svg>',
  todoEmpty: '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path class="todo-empty-icon" fill="currentColor" transform="matrix(1 0 0 1 2 2)" d="M12 6Q12 3.5147 10.2426 1.7574Q8.4853 0 6 0Q3.5147 0 1.7574 1.7574Q0 3.5147 0 6Q0 8.4853 1.7574 10.2426Q3.5147 12 6 12Q8.4853 12 10.2426 10.2426Q12 8.4853 12 6ZM2.6978 2.6978Q4.0656 1.33 6 1.33Q7.9344 1.33 9.3022 2.6978Q10.67 4.0656 10.67 6Q10.67 7.9344 9.3022 9.3022Q7.9344 10.67 6 10.67Q4.0656 10.67 2.6978 9.3022Q1.33 7.9344 1.33 6Q1.33 4.0656 2.6978 2.6978Z" fill-rule="evenodd"/></svg>',
  warn: '<svg class="tool-svg tool-svg-warning" width="18" height="18" viewBox="0 0 20 20" fill="none"><path d="M9.047 3.14c.41-.72 1.495-.72 1.906 0l6.38 11.18c.406.711-.108 1.6-.953 1.6H3.62c-.845 0-1.359-.889-.953-1.6L9.047 3.14Z" style="stroke:var(--color-accent-orange);fill:var(--color-accent-orange);fill-opacity:0.08" stroke-width="1.7"/><path d="M10 7.2v4.2" style="stroke:var(--color-accent-orange)" stroke-width="1.7" stroke-linecap="round"/><circle cx="10" cy="13.9" r="1" style="fill:var(--color-accent-orange)"/></svg>'
};
