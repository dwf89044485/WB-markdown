...
export const ICONS = {
  ...
  spin: '<svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="8" stroke="currentColor" stroke-width="2"/><path d="M10 2a8 8 0 018 8" stroke="#5e5ce6" stroke-width="2" stroke-linecap="round"/></svg>',
