...
function renderFinalActions() {
  ...
  popover.innerHTML = `
    <button class="response-action-btn" type="button" aria-label="点赞">${RESPONSE_SVGS.like}<span>点赞</span></button>
    <button class="response-action-btn" type="button" aria-label="点踩">${RESPONSE_SVGS.dislike}<span>点踩</span></button>`;
