        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>产品化结论</td>
              <td>主对话流，默认可见</td>
              <td><button class="fp-action-btn" data-action="infoarch-l1" type="button">查看运行态</button></td>
            </tr>
            <tr>
              ...
              <td>任务语言</td>
              <td>展开执行过程后可见</td>
              <td><button class="fp-action-btn" data-action="infoarch-l2" type="button">查看运行态</button></td>
            </tr>
            <tr>
              ...
              <td><button class="fp-action-btn" data-action="infoarch-l3" type="button">查看运行态</button></td>
            </tr>
            <tr>
              ...
              <td><button class="fp-action-btn" data-action="infoarch-l4" type="button">查看运行态</button></td>
            </tr>
          </tbody>
        </table>
      </section>
...
flowchart TD
    ...
    style L4 fill:#fce7f3,stroke:#ec4899</div>
